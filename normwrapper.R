normwrapper <- function(y,y50=NULL,y95=NULL,mcmc=list(nburn = 1000,nsave = 10000, nskip = 10, ndisplay = 100),ngrid=1000,grid=NULL) {
    ...
    if(p==1) {
      ...
      mu <- fit$save.state$randsave[,muidx]%*%kronecker(diag(rep(1,n)),R) + kronecker(matrix(1,nrow=nsave,ncol=n),t(m))
